...
### If you're already using the library, upgrading to 3.4.3 is strongly recommended for security reasons! [Read here](https://github.com/gotev/android-upload-service/releases/tag/3.4
...
|--|--|
| :iphone: | [Download demo APK](https://github.com/gotev/android-upload-service/releases/download/3.4.3/uploadservice-demo-debug.apk)|
